...
//   resume: Resume;
//   onSave: (updatedData: ResumeFormData) => Promise<void>; // now only form data
...
//   // Save handler: calls parent onSave with form data only
//   const handleSave = async () => {
//     setIsSaving(true);
//     try {
//       await onSave(data); // pass only ResumeFormData
//       setMode("preview"); // switch to preview after save
//     } finally {
//       setIsSaving(false);
//     }
//   };

//   // Reset form to initial resume data
//   const handleReset = () => {
//     setData(resume.data);
//   };
...
//       <section className="w-full md:w-1/2 p-6 bg-gray-100 overflow-y-auto">
